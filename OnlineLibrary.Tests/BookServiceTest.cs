...
namespace OnlineLibrary.Tests
{
    public class BookServiceTest
    {
        ...
        {
            new Book {Id = 1, Title = "A Brief History of Time", Author = "Stephen Hawking", Publisher = "Bantam Books"},
            new Book {Id = 2, Title = "Cosmos", Author = "Carl Sagan", Publisher = "Random House"},
            new Book {Id = 3, Title = "Astrophysics for People in a Hurry", Author = "Neil deGrasse Tyson", Publisher = "Norton & Company"},
            new Book {Id = 4, Title = "Packing for Mars", Author = "Mary Roach", Publisher = "Norton & Company"},
            new Book {Id = 5, Title = "The Elegant Universe", Author = "Brian Greene", Publisher = "Norton & Company"}
        };
        ...
        {
            // Arrange
            var searchBookDto = new SearchBookRequestDto { Title = "anica" };
